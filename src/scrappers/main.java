...
public class main {
	...
	{ 
		...
		//System.out.println("Before save keyword tunisie" + Search.source(url).find("tunisie").toString());
		//System.out.println("Before save keyword adresse" + Search.source(url).find("adresse").toString());
		//Crawl.build("http://www.mkgandhi.org").withDownload("/home/dhaker/Desktop/ghandi").withMediaFilter("ghandi").start();
